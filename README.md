...
[![](https://jitpack.io/v/LunkLing/PictureSelector.svg)](https://jitpack.io/#LunkLing/PictureSelector)
[![PRs Welcome](https://img.shields.io/badge/PRs-Welcome-brightgreen.svg)](https://github.com/LunkLing)
...
<!--默认样式 注意* 样式只可修改，不能删除任何一项 否则报错-->
    <style name="picture.default.style" parent="Theme.AppCompat.Light.DarkActionBar">
        ...
        <!--图片列表请选择文字颜色-->
        <item name="picture.please.textColor">@color/tab_color_false</item>
        <!--图片列表已完成文字颜色-->
        <item name="picture.complete.textColor">@color/transparent_white</item>
        <!--图片列表已完成文字背景颜色-->
        <item name="picture.complete.textBackColor">@color/picture_list_text_color</item>
        <!--图片已选数量圆点背景色-->
        <item name="picture.num.style">@drawable/num_oval</item>
        <!--预览界面标题文字颜色-->
        <item name="picture.ac_preview.title.textColor">@color/white</item>
        <!--预览界面请选择文字颜色-->
        <item name="picture.ac_preview.please.textColor">@color/tab_color_false</item>
        <!--预览界面已完成文字颜色-->
        <item name="picture.ac_preview.complete.textColor">@color/transparent_white</item>
        <!--预览界面已完成文字背景颜色-->
        <item name="picture.ac_preview.complete.textBackColor">@color/picture_preview_text_color</item>
        <!--预览界面标题栏背景色-->
