...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private TextView picture_title, picture_right, picture_tv_no, picture_tv_ok, tv_empty,
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        picture_tv_no = findViewById(R.id.picture_tv_no);
    ...
    public void changeImageNumber(List<LocalMedia> selectImages) {
        ...
        id_ll_ok.setEnabled(enable);
        picture_id_preview.setEnabled(enable);
        picture_id_preview.setSelected(enable);
        picture_tv_ok.setSelected(enable);
        picture_tv_no.setVisibility(!enable ? View.VISIBLE : View.GONE);
        picture_tv_ok.setVisibility(enable ? View.VISIBLE : View.GONE);
        if (enable) {
            picture_tv_ok.setBackgroundResource(R.drawable.picture_btn_ok_selector);
            if (numComplete) {
            ...
            picture_tv_ok.setBackground(null);
            if (numComplete) {
